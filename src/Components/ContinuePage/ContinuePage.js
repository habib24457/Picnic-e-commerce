...
const ContinuePage = () => {
    ...
    const checkAdmin = () => {
        ...
        fetch(`https://lychee-surprise-09798.herokuapp.com/getAdmin/${adminMail}`)
            .then(res => res.json())
            .then(data => {
                if (data) {
        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-md-6 mt-5 pt-5">
                    {
                        isAdmin ? <div>
                            ...
                            <button onClick={() => { superAdmin() }} className="button-design">OK</button>
                        </div>
                            : <div>
                                ...
                                <button onClick={() => { checkAdmin() }} className="button-design">Continue</button>
                            </div>
                    }
                ...
                <div className="col-md-6">
                    <img src={adminPhoto} style={{ width: '550px', height: '550px' }} alt="" />
                </div>
            </div>
